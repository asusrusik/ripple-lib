...
class MissingLedgerHistoryError extends RippleError {
  constructor(message = 'Server is missing ledger history in the specified range') {
    super(message)
  }
}

class PendingLedgerVersionError extends RippleError {
  constructor(message = 'maxLedgerVersion is greater than server\'s most recent validated ledger') {
    super(message)
  }
}
