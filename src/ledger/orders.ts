...
function formatResponse(address: string, responses: AccountOffersResponse[]): Order[] {
  let orders: Order[] = []
...
export default async function getOrders(this: RippleAPI, address: string, options: GetOrdersOptions = {}
): Promise<Order[]> {
  // 1. Validate:
