...
function formatBidsAndAsks(orderbook: Orderbook, offers: OfferCreateTransaction[]) {
...
export default async function getOrderbook(this: RippleAPI, address: string, orderbook: Orderbook,
